...
alias gl="git log" 
alias macprefs="~/Dotfiles/macos-system-preferences.sh"
alias ml="mongo-launch"
alias mo="mongo-orchestration"
alias ms="mongosh"
alias mutt="neomutt"
alias o="pypistats overall"
alias pg="LC_ALL='en_US.UTF-8' /opt/homebrew/opt/postgresql@18/bin/postgres -D /opt/homebrew/var/postgresql@18"
alias v="mkv"
alias vi="nvim"
alias s="vrun"
